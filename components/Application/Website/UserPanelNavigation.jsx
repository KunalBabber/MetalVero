...
import { USER_CUSTOM_REQUESTS, USER_DASHBOARD, USER_ORDERS, USER_PROFILE, WEBSITE_LOGIN } from '@/routes/WebsiteRoute'
    ...
    return (
        <div className='border shadow-sm p-4 rounded'>
            <ul>
                ...
                <li className='mb-2'>
                    <Link href={USER_CUSTOM_REQUESTS} className={`block p-3 text-sm rounded hover:bg-primary hover:text-white ${pathname.startsWith(USER_CUSTOM_REQUESTS) ? 'bg-primary text-white' : ''}`} >Custom Requests</Link>
                </li>
