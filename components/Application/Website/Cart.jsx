    ...
    return (
        <Sheet open={open} onOpenChange={setOpen} >
            <SheetTrigger className="relative">
                <BsCart2 size={22} className="text-gray-500 hover:text-primary" />
            ...
            <SheetContent className="sm:max-w-[450px] w-full">
                ...
                <div className="h-[calc(100vh-40px)] pb-4 flex flex-col">
                    ...
                    <div className="border-t pt-5 px-2">
                        ...
                        <div className="flex gap-3 mt-3">
                            ...
                            <Button type="button" asChild className="flex-1" onClick={() => setOpen(false)}>
                                {cart.count ?
