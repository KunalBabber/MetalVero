                                    ...
                                    <table className="w-full">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td className="md:text-end text-left break-all md:break-normal max-w-full py-2">{orderData?.data?.name}</td>
                                            </tr>
                                            <tr>
                                                <td className="font-medium py-2">Email</td>
                                                <td className="md:text-end text-left break-all md:break-normal max-w-full py-2">{orderData?.data?.email}</td>
                                            </tr>
                                            <tr>
                                                <td className="font-medium py-2">Phone</td>
                                                <td className="md:text-end text-left break-all md:break-normal max-w-full py-2">{orderData?.data?.phone}</td>
                                            </tr>
                                            <tr>
                                                <td className="font-medium py-2">Country</td>
                                                <td className="md:text-end text-left break-all md:break-normal max-w-full py-2">{orderData?.data?.country}</td>
                                            </tr>
                                            <tr>
                                                <td className="font-medium py-2">State</td>
                                                <td className="md:text-end text-left break-all md:break-normal max-w-full py-2">{orderData?.data?.state}</td>
                                            </tr>
                                            <tr>
                                                <td className="font-medium py-2">City</td>
                                                <td className="md:text-end text-left break-all md:break-normal max-w-full py-2">{orderData?.data?.city}</td>
                                            </tr>
                                            <tr>
                                                <td className="font-medium py-2">Pincode</td>
                                                <td className="md:text-end text-left break-all md:break-normal max-w-full py-2">{orderData?.data?.pincode}</td>
                                            </tr>
                                            <tr>
                                                <td className="font-medium py-2">Landmark</td>
                                                <td className="md:text-end text-left break-all md:break-normal max-w-full py-2">{orderData?.data?.landmark}</td>
                                            </tr>
                                            <tr>
                                                <td className="font-medium py-2">Order note</td>
                                                <td className="md:text-end text-left break-all md:break-normal max-w-full py-2">{orderData?.data?.ordernote || '---'}</td>
                                            </tr>
